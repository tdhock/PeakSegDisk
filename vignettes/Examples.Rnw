...
%\VignetteBuilder{knitr::knit2pdf}
...
The peak detection algorithm computes the solution to the following
...
columns (chrom, chromStart, chromEnd, count) is \verb|PeakSegFPOP_df|,
